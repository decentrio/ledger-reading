...
func newLedgerBackend(ctx context.Context, config config.ExporterConfig, log *log.Entry) (ledgerbackend.LedgerBackend, string) {
	...
	return backend, networkPassphrase
}
