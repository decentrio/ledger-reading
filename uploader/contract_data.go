...
func (tw *TransactionExtractor) GetPoolLiquidity(data ContractData) (uint64, uint64, uint64, error) {
...
func (tw *TransactionExtractor) GetContractDataEntry() []ContractData {
